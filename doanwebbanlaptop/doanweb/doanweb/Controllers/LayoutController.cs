...
namespace doanweb.Controllers
{
    ...
    {
        WebSiteBanLapTopEntities db = new WebSiteBanLapTopEntities();
        ...
        public PartialViewResult NhaSanXuatAsusPartial()
        {
            ...
            var list = (from sp in db.tbl_sanpham.AsEnumerable()
                        ...
                        where nxb.Id == sp.NhaSanXuat && sp.LoaiSanPham == "LAPTOP"
        ...
        public PartialViewResult NhaSanXuatAcerPartial()
        {
            //var list = db.tbl_nhasanxuat.ToList();
            var list = (from sp in db.tbl_sanpham.AsEnumerable()
                        from nxb in db.tbl_nhasanxuat.AsEnumerable()
                        where nxb.Id == sp.NhaSanXuat && sp.LoaiSanPham == "MÁY TÍNH BẢNG"
                        select new doanweb.Models.tbl_nhasanxuat
                        {
                            Id = nxb.Id,
                            TenNhaSanXuat = nxb.TenNhaSanXuat,
        ...
        //public PartialViewResult NhaSanXuatLenovoPartial()
        //{
        //    var list = (from sp in db.tbl_sanpham.AsEnumerable()
        //                from nxb in db.tbl_nhasanxuat.AsEnumerable()
        //                where nxb.Id == sp.NhaSanXuat && sp.LoaiSanPham == "Lenovo"
        //                select new doanweb.Models.tbl_nhasanxuat
        //                {
        //                    Id = nxb.Id,
        //                    TenNhaSanXuat = nxb.TenNhaSanXuat,
        ...
        //    return PartialView(list);
        //}
        //public PartialViewResult NhaSanXuatDellPartial()
        //{
        //    //var list = db.tbl_nhasanxuat.ToList();
        //    var list = (from sp in db.tbl_sanpham.AsEnumerable()
        //                from nxb in db.tbl_nhasanxuat.AsEnumerable()
        //                where nxb.Id == sp.NhaSanXuat && sp.LoaiSanPham == "Dell"
        //                select new doanweb.Models.tbl_nhasanxuat
        //                {
        //                    Id = nxb.Id,
        //                    TenNhaSanXuat = nxb.TenNhaSanXuat,
